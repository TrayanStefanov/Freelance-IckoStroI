    ...
    <div className='min-h-screen overflow-hidden my-10'>
      ...
      <div className='text-primary'>
        ...
        <div className='max-w-[80vw] hidden lg:flex sm:flex-col lg:flex-row m-auto justify-around justify-self-center'>
          <div className='xl:w-1/5 p-10 border-accent border-4 rounded-xl border-double justify-items-center text-center bg-secondary m-2'>
      ...
      <div className='text-primary max-w-[80vw] mx-auto'>
        <h2 className='text-7xl md:text-6xl lg:text-5xl text-center my-10 p-10'>{t("about.team.title")}</h2>
        <img className='object-cover w-full' src="./aboutUs-team.jpg" alt="" />
      </div>
    </div>
  )
}
