...
const AboutUs = () => {
  ...
  return (
    <div className='min-h-screen overflow-hidden my-10'>
      <div className='md:min-h-[70vh] flex flex-col md:flex-row items-center justify-center lg:p-10'>
        <img className='lg:w-1/4 max-h-[40vh] lg:max-h-[60vh] object-contain rotate-15 border-secondary border-4 rounded-3xl' src="./aboutUs-solo.jpg" alt="" />
        <div className='lg:w-1/2 p-10 lg:p-20 text-primary ms-10 border-accent border-4 bg-base-200 rounded-3xl z-10'>
          <h1 className='text-6xl md:text-5xl lg:text-4xl text-center mb-6'>{t("about.intro.title")}</h1>
          <p className='text-l my-2'>{t("about.intro.paragraph.1")}</p>
          <p className='text-l my-2'>{t("about.intro.paragraph.2")}</p>
          <h3 className='text-5xl md:text-4xl lg:text-3xl my-6'>{t("about.intro.subtitle")}</h3>
      ...
      <div className='text-primary'>
        <h2 className='text-6xl md:text-5xl lg:text-4xl text-center mb-6 p-10'>{t("about.issues.title")}</h2>
        ...
        <div className='max-w-[90vw] flex md:hidden flex-col lg:hidden m-auto justify-around justify-self-center'>
          <div className='min-h-[30vh] p-4 border-accent border-4 rounded-xl border-double justify-items-center text-center bg-secondary m-2'>
      ...
      <div className='text-primary max-w-[80vw] mx-auto'>
        <h2 className='text-6xl md:text-5xl lg:text-4xl text-center my-10 p-10'>{t("about.team.title")}</h2>
