  ...
  return (
    <div className="font-pf">
      <Helmet>
        ...
        <meta name="description" content={t("site.pages.services.description")} />
        ...
        <meta property="og:description" content={t("site.pages.services.description")} />
        ...
        <meta name="twitter:description" content={t("site.pages.services.description")} />
          ...
          {servicesList.map((service, idx) => (
            ...
            >
              ...
              <div className="collapse-content">
                <img src={service.image} className="object-contain rounded-md mb-4" />
