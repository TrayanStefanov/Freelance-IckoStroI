...
const LanguageSelector = () => {
  ...
  return (
    <select
      ...
      className="font-pf p-2 bg-secondary text-primary border-primary border-2 self-center text-center focus:text-neutral-content focus:bg-neutral hover:text-neutral-content hover:bg-neutral"
    >
